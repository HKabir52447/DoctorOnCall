...
const AddDoctor = () => {
  return (
    <>
      <h1 className="text-center text-2xl font-bold pb-3">Add New Doctor</h1>
      ...
      <form className="max-w-md mx-auto">
        <div className="relative z-0 w-full mb-5 group">
          <input
            type="text"
            name="floating_name"
            className="block py-2.5 px-0 w-full text-md text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
            placeholder=" "
            required
          />
          <label
        ...
        <div className="relative z-0 w-full mb-5 group">
          <textarea
            name="description"
            rows="4"
            className="block py-2.5 px-3 w-full text-md text-black bg-transparent border border-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer rounded-md"
            placeholder="Description..."
          ></textarea>
        </div>
        <button
          type="submit"
          className="font-bold border-2 border-transparent py-1 px-6 bg-green-500 text-white duration-100 mt-8 hover:bg-white hover:text-green-500 rounded-md hover:border-green-500"
        >
          Submit
        </button>
      </form>
